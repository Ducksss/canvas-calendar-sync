...
4. Confirm the MIT license, enable private vulnerability reporting, and enable
   the optional test workflow with a credential authorized to upload workflows.
